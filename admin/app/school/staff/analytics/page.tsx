...
const classAnalytics = [
	{ name: "Mr Samuel", attendance: 96, trend: "Improving", absenteeism: "Low" },
	{ name: "Ms Johnson", attendance: 88, trend: "Declining", absenteeism: "Moderate" },
	{ name: "Mr Davis", attendance: 91, trend: "Improving", absenteeism: "Low" },
	{ name: "Mrs Wilson", attendance: 97, trend: "Improving", absenteeism: "Low" },
];
		...
		<section className="space-y-6 py-4">
			<Card className="overflow-hidden border border-default-200/70 bg-background/90">
				<CardHeader className="flex flex-col items-start gap-4 px-6 pt-6 md:flex-row md:items-center md:justify-between">
					...
					<Button as={Link} href="/school/staff/attendance" radius="full" variant="bordered">
						Back to Attendance
					</Button>
				</CardHeader>
