...
const pastAttendanceByDate = [
  ...
  },
  {
    date: "2026-04-11",
    records: [
      { className: "Mrs Smith-Gold", present: 35, absent: 1, rate: "97%", trend: "Up" },
      { className: "Mr Oluwagbemi", present: 31, absent: 3, rate: "91%", trend: "Up" },
      { className: "Mr Smart", present: 30, absent: 2, rate: "94%", trend: "Up" },
      { className: "Mr James Paul", present: 28, absent: 1, rate: "97%", trend: "Up" },
    ],
  },
  {
    date: "2026-04-10",
    records: [
      { className: "Mrs Smith-Gold", present: 32, absent: 4, rate: "89%", trend: "Down" },
      { className: "Mr Oluwagbemi", present: 30, absent: 4, rate: "88%", trend: "Down" },
      { className: "Mr Smart", present: 29, absent: 3, rate: "91%", trend: "Up" },
      { className: "Mr James Paul", present: 26, absent: 3, rate: "90%", trend: "Down" },
    ],
  },
  {
    date: "2026-04-09",
    records: [
      { className: "Mrs Smith-Gold", present: 34, absent: 2, rate: "94%", trend: "Up" },
      { className: "Mr Oluwagbemi", present: 32, absent: 2, rate: "94%", trend: "Up" },
      { className: "Mr Smart", present: 31, absent: 1, rate: "97%", trend: "Up" },
      { className: "Mr James Paul", present: 27, absent: 2, rate: "93%", trend: "Up" },
    ],
  },
];
    ...
    <section className="space-y-5 py-4">
      <Card className="border border-default-200/70 bg-background/85">
        <CardHeader className="px-6 pt-6 flex items-center justify-between gap-3">
          ...
          <Link href="/school/staff/attendance/analytics">
