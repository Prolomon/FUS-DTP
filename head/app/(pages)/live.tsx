...
const LIVE_FEEDS: LiveFeed[] = [
	{
		...
		quality: 'HD adaptive',
		location: 'Worldwide',
		url: 'https://ADUDA-server.onrender.com/feed/live/1',
	},
	{
		id: 'assembly',
		title: 'Assembly',
	...
	},
	{
		...
		url: 'https://ADUDA-server.onrender.com/feed/live/8',
	},
];
...
export default function LiveScreen() {
	...
	const onRefresh = () => {
		setRefreshing(true);
		// Optionally, you could reload the selected feed or do more here
		setTimeout(() => {
			setRefreshing(false);
		}, 800);
	};
		...
		<SafeAreaView style={styles.container}>
			...
			>
				<View style={styles.fullscreenContainer}>
					{(
						<WebView
							key={selectedFeed.id + '-fullscreen'}
							source={{ uri: selectedFeed.url }}
