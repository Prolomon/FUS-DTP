...
const staffGroupName = 'Security Staff Group';
const pickupCode = '48291735';
        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                <View style={styles.classCard}>
                    <Text style={styles.classLabel}>Staff Group</Text>
                    <Text style={styles.className}>{staffGroupName}</Text>

                    <Text style={styles.codeLabel}>Pick Up Code</Text>
                    <View style={styles.codeRow}>
                        {pickupCode.split('').map((digit, index) => (
                            <View key={`${digit}-${index}`} style={styles.codeBox}>
                                <Text style={styles.codeText}>{showPickupCode ? digit : '*'}</Text>
                            </View>
                        ))}
                    </View>
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => setShowPickupCode((prev) => !prev)}
                    >
                        <Text style={styles.revealButtonText}>{showPickupCode ? 'Hide Code' : 'Reveal Code'}</Text>
                    </TouchableOpacity>
                </View>

                <View style={styles.studentsSection}>
                    <View style={styles.studentsHeaderRow}>
                        <Text style={styles.studentsTitle}>Pick Up Students</Text>
